	...
	<!-- Patient Report Content -->
          ...
          <ul data-role="listview" data-inset="false" data-icon="false" data-divider-theme="b">
		        ...
		        <form method="post" action="<?php $_PHP_SELF ?>" data-ajax="false" > 
							...
							<tr>  
								<td><input style="color:#fff; font-size: 20px; padding: 10px;" name="note" type="text" id="note" placeholder="Add Report"  ></td>
							</tr>
...
<ul data-role="listview" data-inset="false">
                    ...
                    <li data-role="fieldcontain">
                        <input style="color:#fff; font-size:19px;" type="text" name="hr" id="hr" value="" data-clear-btn="true" placeholder="Hours">
						
                        <input style="color:#fff; font-size:19px;" type="text" name="mn" id="mn" value="" data-clear-btn="true" placeholder="Minutes">
						
                        <input style="color:#fff; font-size:19px;" type="text" name="sec" id="sec" value="" data-clear-btn="true" placeholder="Seconds">
